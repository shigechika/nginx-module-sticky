...
%define MODULE_NAME nginx-sticky-module-ng
...
git clone https://bitbucket.org/LeMovieStoreGuy/nginx-sticky-module-ng.git
...
%{__install} -m 644 -p %{bdir}/nginx-sticky-module-ng/LICENSE \
